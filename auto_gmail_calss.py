...
class EmailAutoResponder:
    ...
    def send_gmail(self, sender_address, receiver_address, mail_subject, mail_content):
        ...
        session.starttls()
        session.login(sender_address, self.gmail_app_password)
    ...
    def send_response_email(self, msg, message_to_send, mail, num):
        ...
        try:
            self.send_gmail(self.gmail_address, from_email, subject, message_to_send)
